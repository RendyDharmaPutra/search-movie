...
export default function Pagination(): JSX.Element {
	...
	return (
		<section className="p-layout flex flex-row justify-between sm:justify-end gap-4 w-full rounded-2xl bg-white">
			<button
				disabled={currentPage === 1}
				onClick={() => setPage(false)}
				className={`${
					currentPage === 1 ? "btn text-gray-800 bg-gray-200" : "btn-secondary"
				}`}
			>
				Sebelumnya
			</button>
